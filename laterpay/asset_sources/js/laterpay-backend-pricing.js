(function($) {$(function() {
    ...
    function laterPayBackendPricing() {
        var $o = {
                ...
                bulkPriceFormHiddenField                : $('#lp_js_bulkPriceFormHidden'),
                bulkPriceOperationIdHiddenField         : $('#lp_js_bulkOperationIdHidden'),
                bulkPriceMessageHiddenField             : $('#lp_js_bulkMessageHidden'),
