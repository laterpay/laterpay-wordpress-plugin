<div class="lp-page wp-core-ui">
    ...
    <div class="tabs-area">
        <?php if ( ! $plugin_is_in_live_mode ): ?>
            <a href="<?php echo add_query_arg( array( 'page' => LaterPay_View_Helper::$admin_menu['account']['url'] ), admin_url( 'admin.php' ) ); ?>" id="plugin-mode-indicator" data-icon="h">
                        ...
                        <?php foreach ( $Categories as $item ): ?>
                            <form method="post" class="category-price-form">
                                <p>
                                    ...
                                    <strong>
                                        <?php $category_price = LaterPay_View_Helper::format_number( (float) $item->category_price, 2 ); ?>
                                        <input  type="text"
                                                name="price"
                                                class="lp-input number"
                                                value="<?php echo LaterPay_View_Helper::format_number($item->category_price, 2); ?>"
                                                style="display:none;"
                                                placeholder="<?php _e( '0.00', 'laterpay' ); ?>">
