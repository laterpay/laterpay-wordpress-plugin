    ...
    <div class="lp-wrap">
        ...
        <div class="lp-form-row">
            ...
            <code class="invoice-snippet">
                ...
                <?php echo htmlspecialchars('<div id="balancecontainer"></div><script>YUI().use("node","laterpay-dialog","laterpay-iframe","laterpay-easyxdm",function(a){lpVars&&lpVars.lpBalanceUrl&&new a.LaterPay.IFrame(a.one("#balancecontainer"),lpVars.lpBalanceUrl,{width:"150",height:"30",scrolling:"no",frameborder:"0",style:"float: right"})});</script>'); ?>
            </code>
        </div>
    </div>
