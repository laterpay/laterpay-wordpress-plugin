...
class LaterPay_Pricing_Controller extends LaterPay_Abstract_Controller
{
    ...
    public function render_page() {
        ...
        $Currency = new LaterPay_Currency_Model();
        ...
        $this->assign( 'global_default_price',   LaterPay_View_Helper::format_number( (float) get_option( 'laterpay_global_price' ), 2 ) );
        $this->assign( 'top_nav',                $this->get_menu() );

        $this->render( 'plugin-backend-pricing-tab' );
    }
    ...
    protected static function _update_global_default_price() {
        ...
        $global_price       = LaterPay_View_Helper::format_number( (float) get_option( 'laterpay_global_price' ), 2 );
        $Currency           = new LaterPay_Currency_Model();
    ...
    protected static function _update_existing_category_default_price() {
        ...
        if ( empty( $id ) && empty( $id_category ) ) {
            ...
            if ( $id ) {
                ...
                $formatted_category_price   = LaterPay_View_Helper::format_number( (float) $category_price, 2 );
