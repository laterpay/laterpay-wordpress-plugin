...
class LaterPay_Core_Logger_Formatter_Html extends LaterPay_Core_Logger_Formatter_Normalizer
{
    ...
    public function format( array $record ) {
        $output  = '<li>';
        $output .= '<table class="lp_debugger-content__table lp_debugger-content__table--is-hidden lp_js_debugger-logEntryTable">';
    ...
    private function add_head_row( $message = '', $level ) {
        ...
        $html = "<thead class='lp_debugger-content__table-title'>
                    <tr>
                        <td class='lp_debugger-content__table-td'><span class=\"lp_debugger_logLevel lp_debugger_logLevel-$level lp_vectorIcon\"></span>$message</td>
