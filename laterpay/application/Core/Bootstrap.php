...
class LaterPay_Core_Bootstrap
{
    ...
    public function run() {
         ...
         * ->   the priority has to be 1 (very first filter which is triggered)
         *      to fetch and manipulate content as first and before other filters are triggered (wp_embed, wpautop, external plugins/themes, ...)
         */
