...
class LaterPay_Model_TimePass
{
    ...
    function __construct() {
        ...
        $this->time_passes_table = $wpdb->prefix . 'laterpay_passes';
    }
    ...
    public function delete_time_pass_by_id( $time_pass_id ) {
        ...
        return $wpdb->update( $this->time_passes_table, array( 'is_deleted' => 1 ), $where, array( '%d' ), array( '%d' ) );
    }
