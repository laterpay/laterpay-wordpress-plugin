...
class LaterPay_Module_TimePasses extends LaterPay_Core_View implements LaterPay_Core_Event_SubscriberInterface {
    ...
    public function the_time_passes_widget( LaterPay_Core_Event $event ) {
        ...
        $get_purchase_button_position = (bool) get_option( 'laterpay_time_passes_positioned_manually' );
        ...
        if ( $is_purchasable && $get_purchase_button_position && ! wp_doing_ajax() && 'laterpay_time_passes' === current_action() ) {
