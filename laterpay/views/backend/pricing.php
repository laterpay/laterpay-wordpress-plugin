                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <select name="duration" class="lp_js_switchTimePassDuration lp_input">
                                            <?php echo LaterPay_Helper_Pass::get_select_options( 'duration' ); ?>
                                        </select>
                                        <select name="period" class="lp_js_switchTimePassPeriod lp_input">
                                            <?php echo LaterPay_Helper_Pass::get_select_options( 'period' ); ?>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="access_to" class="lp_js_switchTimePassScope lp_input lp_u_w-1">
                                            <?php echo LaterPay_Helper_Pass::get_select_options( 'access' ); ?>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <input type="text"
                                                ...
                                                value="<?php echo LaterPay_Helper_View::format_number( LaterPay_Helper_Pass::get_default_options( 'price' ) ) ?>">
                                        ...
                                        <?php _e( 'later', 'laterpay' ); ?><div class="lp_toggle">
                                            <label class="lp_toggle_label lp_toggle_label_pass">
                                                <input type="checkbox"
                                                       ...
                                                       value="sis"
                                                       <?php if ( LaterPay_Helper_Pass::get_default_options( 'revenue_model' ) === 'sis' ) { echo 'checked'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text"
                                                ...
                                                value="<?php echo LaterPay_Helper_Pass::get_default_options( 'title' ); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <textarea
                                            ...
                                            <?php echo LaterPay_Helper_Pass::get_description(); ?>
                                        </textarea>
                                    </td>
                                </tr>
                                <tr>
