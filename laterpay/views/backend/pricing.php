...
-->
                ...
                <a href="#" id="lp_js_addCategoryDefaultPrice" class="lp_block lp_pd" data-icon="c"><?php _e( 'Set default price for another category', 'laterpay' ); ?></a>
...
-->
            <div class="lp_js_timePassEditor lp_time-passes__list lp_clearfix">
