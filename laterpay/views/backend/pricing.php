    ...
    <div class="lp_pagewrap">
        ...
        <div class="lp_row">
            ...
            <form id="lp_js_bulk-price-form" method="post">
                <input type="hidden" name="form" value="bulk_price_form" id="lp_js_bulkPriceFormHidden">
                <input type="hidden" name="action" value="laterpay_pricing">
                <input type="hidden" name="bulk_operation_id" value="" id="lp_js_bulkOperationIdHidden">
                <input type="hidden" name="bulk_message" value="" id="lp_js_bulkMessageHidden">
                <?php if ( function_exists( 'wp_nonce_field' ) ) { wp_nonce_field( 'laterpay_form' ); } ?>
                <div>
                    <p>
                        ...
                        <a href="#" id="lp_js_saveBulkOperation" class="lp_edit-link lp_save-link lp_d-inl-block lp_m-l1 lp_pd-0-05" data-icon="f"><?php _e( 'Save', 'laterpay' ); ?></a>
                    </p>
                </div>
            </form>
