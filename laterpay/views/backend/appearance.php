...
<div class="lp_page wp-core-ui">
    ...
    <div class="lp_pagewrap">
        ...
        <div class="lp_row">
            ...
            <form id="laterpay_supported_post_types_form" method="post">
                <input type="hidden" name="form"    value="supported_post_types">
                <input type="hidden" name="action"  value="laterpay_appearance">
                <?php wp_nonce_field('laterpay_form'); ?>
                <?php
                $supported_post_types   = $config->get( 'content.allowed_post_types' );
                    ...
                    <div>
                        <label for="supported_post_type_<?php echo $slug; ?>" >
                            <input type="checkbox"
                                   ...
                                   value="<?php echo $slug; ?>"
                                   class=""
                                   <?php echo ( in_array( $slug, $supported_post_types ) ) ? ' checked="checked" ' : ''; ?>
                            />
