...
<div class="lp_page wp-core-ui">
    ...
    <div class="lp_pagewrap">
        ...
        <div class="lp_row lp_u_clearfix lp_u_m-b1">
            <form id="lp_js_laterpayPurchaseButtonPositionForm" method="post">
                <input type="hidden" name="form" value="purchase_button_position">
                <input type="hidden" name="action" value="laterpay_appearance">
                <?php if ( function_exists( 'wp_nonce_field' ) ) { wp_nonce_field('laterpay_form'); } ?>
                <h3><?php _e( 'Position of LaterPay Purchase Button', 'laterpay' ); ?></h3>
                <?php _e( 'The LaterPay button is positioned automatically', 'laterpay' ); ?>
                <div class="lp_toggle">
                    <label class="lp_toggle_label lp_toggle_label_pass">
                        <input type="checkbox" id="lp_js_togglePurchaseButtonPosition" name="purchase_button_positioned_manually" class="lp_toggle_input" value="1" <?php if ( $laterpay['purchase_button_positioned_manually'] ): ?>checked<?php endif; ?>>
                        <span class="lp_toggle_text" data-on="" data-off=""></span>
                        <span class="lp_toggle_handle"></span>
                    </label>
                </div>
                <?php _e( 'manually (with an action)', 'laterpay' )?>
                <br>
                <dfn class="lp_u_clearfix">
        ...
        <div class="lp_row lp_u_clearfix lp_u_m-b1">
            <form id="lp_js_laterpayTimePassPositionForm" method="post">
                ...
                <?php _e( 'Time passes are positioned automatically', 'laterpay' ); ?>
                <div class="lp_toggle">
                    <label class="lp_toggle_label lp_toggle_label_pass">
                        <input type="checkbox" id="lp_js_toggleTimePassesPosition" name="time_passes_positioned_manually" class="lp_toggle_input" value="1" <?php if ( $laterpay['time_passes_positioned_manually'] ): ?>checked<?php endif; ?>>
                        <span class="lp_toggle_text" data-on="" data-off=""></span>
                        <span class="lp_toggle_handle"></span>
                    </label>
                </div>
