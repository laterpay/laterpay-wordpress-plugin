...
<div class="lp_page wp-core-ui">
    ...
    <div class="lp_pagewrap">
        ...
        <div class="lp_row">
            ...
            <code class="lp_code-snippet lp_shown-above lp_u_block">
        ...
        <div class="lp_row">
            ...
            <img class="lp_ui-element-preview-large lp_u_m-t05" src="<?php echo $config->get( 'image_url' ) . 'shortcode-alignment-2x.png'; ?>">
        </div>
        <hr class="lp_u_m-1-0 lp_u_m-b3">
