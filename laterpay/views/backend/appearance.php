    ...
    <div class="lp_pagewrap lp_appearence">
        ...
        <div class="lp_row lp_u_clearfix lp_u_m-b1 lp_appearence__item">
            ...
            <div class="lp_u_clearfix lp_u_m-b2">
                <img class="lp_element-preview lp--large lp_u_left lp_u_m-r2" src="<?php echo $config->get( 'image_url' ) . 'gift-card-instructions-step-1.png'; ?>">
                ...
                <code class="lp_code-snippet lp--large lp_u_block">
            ...
            <div class="lp_u_clearfix">
                <img class="lp_element-preview lp--large lp_u_left lp_u_m-r2" src="<?php echo $config->get( 'image_url' ) . 'gift-card-instructions-step-2.png'; ?>">
                <strong class="lp_u_block lp_u_m-t1 lp_u_m-b05 lp_u_pd-t05">
        ...
        <div class="lp_row lp_u_clearfix lp_u_m-b1 lp_appearence__item">
            ...
            <img class="lp_element-preview lp--large lp_u_left lp_u_m-t05 lp_u_m-r2" src="<?php echo $config->get( 'image_url' ) . 'content-rating-2x.png'; ?>">
            <div class="lp_u_m-t2">
        ...
        <div class="lp_appearence__item">
            <div class="lp_row">
                ...
                <table class="lp_u_m-b1">
                    <tr>
                        <td class="lp_u_pd-l0">
                            <img class="lp_element-preview lp--large" src="<?php echo $config->get( 'image_url' ) . 'shortcode-2x.png'; ?>">
                        </td>
                        <td>
                            <table>
                                <tr>
            ...
            <div class="lp_row">
                ...
                <img class="lp_element-preview lp--large lp_u_m-t05" src="<?php echo $config->get( 'image_url' ) . 'shortcode-alignment-2x.png'; ?>">
            </div>
         </div>
        <hr class="lp_u_m-1-0 lp_u_m-b3">
        <div class="lp_appearence__item">
            ...
            <div class="lp_row lp_u_clearfix lp_u_m-b2">
                ...
                <img class="lp_element-preview lp_u_left lp_u_m-0 lp_u_m-t1" src="data:image/png;base64,
