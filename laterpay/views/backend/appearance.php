...
<div class="lp_page wp-core-ui">
    ...
    <div class="lp_pagewrap lp_appearence">
        ...
        <div class="lp_row lp_clearfix lp_u_m-b1 lp_appearence__item">
            ...
            <div class="lp_clearfix lp_u_m-b2">
                <img class="lp_ui-element-preview lp_ui-element-preview--large lp_left lp_u_m-r2" src="<?php echo $config->get( 'image_url' ) . 'gift-card-instructions-step-1.png'; ?>">
                <strong class="lp_block lp_u_m-t1 lp_u_m-b05 lp_u_pd-t05">
            ...
            <div class="lp_clearfix">
                <img class="lp_ui-element-preview lp_ui-element-preview--large lp_left lp_u_m-r2" src="<?php echo $config->get( 'image_url' ) . 'gift-card-instructions-step-2.png'; ?>">
                <strong class="lp_block lp_u_m-t1 lp_u_m-b05 lp_u_pd-t05">
        ...
        <div class="lp_row lp_clearfix lp_u_m-b1 lp_appearence__item">
            ...
            <img class="lp_ui-element-preview lp_ui-element-preview--large lp_left lp_u_m-t05 lp_u_m-r2" src="<?php echo $config->get( 'image_url' ) . 'content-rating-2x.png'; ?>">
            <div class="lp_u_m-t2">
        ...
        <div class="lp_appearence__item">
            ...
            <div class="lp_row lp_clearfix lp_u_m-b2">
            ...
            <div class="lp_row lp_clearfix lp_u_m-b2">
                ...
                <img class="lp_ui-element-preview lp_left lp_m--0 lp_u_m-t1" src="data:image/png;base64,
