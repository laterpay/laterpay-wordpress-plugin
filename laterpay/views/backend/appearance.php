...
<div class="lp_page wp-core-ui">
    ...
    <div class="lp_pagewrap lp_appearence">
        ...
        <div class="lp_clearfix lp_appearence__item">
            <h2><?php echo laterpay_sanitize_output( __( 'Preview of Paid Content', 'laterpay' ) ); ?></h2>
        ...
        <div class="lp_clearfix lp_appearence__item">
            ...
            <div class="lp_clearfix lp_mb+">
                <img class="lp_ui-element-preview lp_ui-element-preview--large lp_left lp_mt lp_mr+" src="<?php echo esc_url_raw( $config->get( 'image_url' ) . 'gift-card-instructions-step-1.png' ); ?>">
            ...
            <div class="lp_clearfix">
                <img class="lp_ui-element-preview lp_ui-element-preview--large lp_left lp_mt lp_mr+" src="<?php echo esc_url_raw( $config->get( 'image_url' ) . 'gift-card-instructions-step-2.png' ); ?>">
                <strong class="lp_block lp_mt lp_mb- lp_pdt-">
        ...
        <div class="lp_clearfix lp_appearence__item">
            ...
            <img class="lp_ui-element-preview lp_ui-element-preview--large lp_left lp_mt- lp_mr+" src="<?php echo esc_url_raw( $config->get( 'image_url' ) . 'content-rating-2x.png' ); ?>">
            <div class="lp_mt+">
                <?php echo laterpay_sanitize_output( __( 'Content rating is', 'laterpay' ) ); ?><div class="lp_toggle">
                    <form id="lp_js_laterpayRatingsForm" method="post">
                        ...
                        <label class="lp_toggle__label">
                            ...
                            <span class="lp_toggle__text" data-on="<?php echo esc_attr( __( 'on', 'laterpay' ) ); ?>" data-off="<?php echo esc_attr( __( 'off', 'laterpay' ) ); ?>"></span>
        ...
        <div class="lp_clearfix lp_appearence__item">
            <div>
                ...
                <table class="lp_mb">
                    <tr>
                        <td class="lp_pdl0">
                            <img class="lp_ui-element-preview lp_ui-element-preview--large" src="<?php echo esc_url_raw( $config->get( 'image_url' ) . 'shortcode-2x.png' ); ?>">
                        </td>
                        <td>
                            <table>
                                <tr>
            ...
            <div class="lp_clearfix">
                ...
                <img class="lp_ui-element-preview lp_ui-element-preview--large lp_left lp_mt lp_mr+" src="<?php echo esc_url_raw( $config->get( 'image_url' ) . 'shortcode-alignment-2x.png' ); ?>">
                <code class="lp_code-snippet lp_code-snippet--large lp_block">
                    <div class="lp_triangle lp_triangle--outer-triangle"><div class="lp_triangle"></div></div>
        ...
        <div class="lp_appearence__item">
            <div>
                <h2><?php echo laterpay_sanitize_output( __( 'Integration Into Theme', 'laterpay' ) ); ?></h2>
            </div>
            ...
            <div class="lp_clearfix lp_mb+">
                <form id="lp_js_purchaseButtonPositionForm" method="post">
                    ...
                    <input type="hidden" name="action" value="laterpay_appearance">
                    <?php if ( function_exists( 'wp_nonce_field' ) ) { wp_nonce_field( 'laterpay_form' ); } ?>
                    <h3><?php echo laterpay_sanitize_output( __( 'Position of LaterPay Purchase Button', 'laterpay' ) ); ?></h3>
                    <?php echo laterpay_sanitize_output( __( 'Purchase buttons are rendered at their <strong>default position</strong>', 'laterpay' ) ); ?><!--
                 --><div class="lp_toggle">
                 ...
                 --><?php echo laterpay_sanitize_output( __( 'at a <strong>custom position</strong>.', 'laterpay' ) ); ?>
            ...
            <div class="lp_clearfix lp_mb+">
                <form id="lp_js_timePassesPositionForm" method="post">
                    ...
                    <input type="hidden" name="action" value="laterpay_appearance">
                    <?php if ( function_exists( 'wp_nonce_field' ) ) { wp_nonce_field( 'laterpay_form' ); } ?>
                    <h3 id="lp_timePassAppearance"><?php echo laterpay_sanitize_output( __( 'Display of Time Passes', 'laterpay' ) ); ?></h3>
                    <?php echo laterpay_sanitize_output( __( 'Time passes are rendered at their <strong>default position</strong>', 'laterpay' ) ); ?><!--
                 --><div class="lp_toggle">
                 ...
                 --><?php echo laterpay_sanitize_output( __( 'at a <strong>custom position</strong>.', 'laterpay' ) ); ?>
                    <div id="lp_js_timePassesPositionExplanation"<?php if ( ! $laterpay['time_passes_positioned_manually'] ) : ?> style="display:none;"<?php endif; ?>>
                        <dfn class="lp_clearfix">
                            ...
                            <?php echo laterpay_sanitize_output( __( 'The default width for time passes is 308px. By adding the parameter \'small\', they will be displayed with a width of 224px.', 'laterpay' ) ); ?>
                        </dfn>
                        ...
                        <code class="lp_code-snippet lp_block">
                            ...
                            <strong>Action:</strong><?php echo esc_html( " <?php do_action( 'laterpay_time_passes' ); ?>" ); ?>
                            <div class="lp_text-align--center lp_m"><?php echo laterpay_sanitize_output( __( 'or', 'laterpay' ) ); ?></div>
                            <strong>Shortcode:</strong> [laterpay_time_passes variant="small"]<br>
                            <strong>Action:</strong><?php echo esc_html( " <?php do_action( 'laterpay_time_passes', 'small' ); ?>" ); ?>
                        </code>
                    </div>
                </form>
            </div>
