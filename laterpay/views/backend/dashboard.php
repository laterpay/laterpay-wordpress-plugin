            ...
            <div class="lp_layout">
                <div class="lp_layout__item lp_1/3">
                    <div class="lp_greybox--outline lp_mr lp_mb">
                        <h3 class="lp_text-align--center"><?php _e( 'Best-converting Items', 'laterpay' ); ?></h3>
                    ...
                    <div class="lp_greybox--outline lp_mr lp_mb">
                        <h3 class="lp_text-align--center"><?php _e( 'Least-converting Items', 'laterpay' ); ?></h3>
             ...
             --><div class="lp_layout__item lp_1/3">
                    <div class="lp_greybox--outline lp_mr lp_mb">
                        <h3 class="lp_text-align--center"><?php _e( 'Most-selling Items', 'laterpay' ); ?></h3>
                    ...
                    <div class="lp_greybox--outline lp_mr lp_mb">
                        <h3 class="lp_text-align--center"><?php _e( 'Least-selling Items', 'laterpay' ); ?></h3>
             ...
             --><div class="lp_layout__item lp_1/3">
                    <div class="lp_greybox--outline lp_mr lp_mb">
                        <h3 class="lp_text-align--center"><?php _e( 'Most Revenue-generating Items', 'laterpay' ); ?></h3>
                    ...
                    <div class="lp_greybox--outline lp_mr lp_mb">
                        <h3 class="lp_text-align--center"><?php _e( 'Least Revenue-generating Items', 'laterpay' ); ?></h3>
