...
<div id="laterpay-price-type"<?php if ( in_array( $laterpay_post_price_type, array( LaterPay_Helper_Pricing::TYPE_DYNAMIC_PRICE, LaterPay_Helper_Pricing::TYPE_CATEGORY_PRICE ) ) ) { echo ' class="expanded"'; } ?>>
     <ul class="lp-toggle clearfix">
        ...
        <li class=" <?php if ( $laterpay_post_price_type == LaterPay_Helper_Pricing::TYPE_CATEGORY_PRICE ) { echo 'selected'; } ?>
        ...
        <li class=" <?php if ( $laterpay_post_price_type == LaterPay_Helper_Pricing::TYPE_DEFAULT_PRICE || ($laterpay_post_price_type == '' && $laterpay_global_default_price > 0) ) { echo 'selected'; } ?>
    ...
    <div id="laterpay-price-type-details">
        <div id="laterpay-dynamic-pricing" class="use-individual-price details-section"<?php if ( $laterpay_post_price_type !== LaterPay_Helper_Pricing::TYPE_DYNAMIC_PRICE ) { echo ' style="display:none;"'; } ?>>
        ...
        <div class="use-category-default-price details-section"<?php if ( $laterpay_post_price_type !== LaterPay_Helper_Pricing::TYPE_CATEGORY_PRICE ) { echo ' style="display:none;"'; } ?>>
...
<?php if ( $laterpay_post_price_type == LaterPay_Helper_Pricing::TYPE_DYNAMIC_PRICE ): ?>
