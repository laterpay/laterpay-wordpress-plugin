...
<div class="lp_postPrice lp_u_clearfix">
    ...
    <div id="lp_js_post-revenue-model" class="lp_postRevenueModel lp_u_relative">
...
<div id="lp_js_price-type" class="lp_priceType<?php if ( in_array( $laterpay_post_price_type, array( LaterPay_Helper_Pricing::TYPE_INDIVIDUAL_DYNAMIC_PRICE, LaterPay_Helper_Pricing::TYPE_CATEGORY_DEFAULT_PRICE ) ) ) { echo ' lp_is-expanded'; } ?>">
     <ul id="lp_js_price-type-button-group" class="lp_buttonGroup lp_u_clearfix">
        ...
        <li class="<?php if ( $laterpay_post_price_type == LaterPay_Helper_Pricing::TYPE_CATEGORY_DEFAULT_PRICE ) { echo 'lp_is-selected'; } ?><?php if ( ! count( $laterpay_category_prices ) ) { echo 'lp_is-disabled'; } ?>">
            <a href="#"
                ...
                class="lp_js_price-type-button lp_useCategoryDefaultPrice"><?php _e( 'Category Default Price', 'laterpay' ); ?></a>
        </li>
    ...
    <div id="lp_js_price-type-details" class="lp_priceType_details">
        <div id="lp_js_individual-price-details" class="lp_js_use-individual-price lp_js_details-section"<?php if ( $laterpay_post_price_type !== LaterPay_Helper_Pricing::TYPE_INDIVIDUAL_DYNAMIC_PRICE ) { echo ' style="display:none;"'; } ?>>
            ...
            <div id="lp_js_dynamic-pricing-widget-container" class="lp_dynamicPricing"></div>
        </div>
        <div id="lp_js_category-price-details" class="lp_js_use-category-default-price lp_useCategoryDefaultPrice lp_js_details-section"<?php if ( $laterpay_post_price_type !== LaterPay_Helper_Pricing::TYPE_CATEGORY_DEFAULT_PRICE ) { echo ' style="display:none;"'; } ?>>
...
<?php if ( $laterpay_post_price_type == LaterPay_Helper_Pricing::TYPE_INDIVIDUAL_DYNAMIC_PRICE ): ?>
    ...
    <a href="#" id="lp_js_toggle-dynamic-pricing" class="lp_dynamicPricingToggle lp_is-with-dynamic-pricing lp_u_block">
