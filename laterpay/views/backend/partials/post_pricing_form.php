...
<div class="lp_postPrice lp_u_clearfix">
    <p class="lp_u_right">
        <input type="text"
                ...
                value="<?php echo number_format_i18n( $laterpay_price, 2 ); ?>"
     ...
     <ul id="lp_js_priceType_buttonGroup" class="lp_buttonGroup lp_u_clearfix">
        ...
        <li class="<?php if ( $laterpay_post_price_type == LaterPay_Helper_Pricing::TYPE_GLOBAL_DEFAULT_PRICE ) { echo 'lp_is-selected'; } ?>">
            <a href="#"
                ...
                data-price="<?php echo number_format_i18n( $laterpay_global_default_price, 2 ); ?>"
                    ...
                    <?php foreach ( $laterpay_category_prices as $c ): ?>
                        <li data-category="<?php echo $c->category_id; ?>"<?php if ( $c->category_id == $laterpay_post_default_category ): ?> class="lp_is-selectedCategory"<?php endif; ?>>
                            <a href="#"
                                ...
                                <span><?php echo number_format_i18n( $c->category_price, 2 ); ?> <?php echo $laterpay_currency; ?></span><?php echo $c->category_name; ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
                <?php endif; ?>
...
<?php if ( $laterpay_post_price_type == LaterPay_Helper_Pricing::TYPE_INDIVIDUAL_DYNAMIC_PRICE ): ?>
    ...
    <?php else: ?>
        <a href="#"
            ...
            data-id="<?php echo $laterpay_post_id; ?>"
...
<?php else: ?>
    <a  href="#"
        ...
        data-icon="c"
        <?php if ( substr( $laterpay_post_price_type, 0, 16 ) !== LaterPay_Helper_Pricing::TYPE_INDIVIDUAL_PRICE ) { echo 'style="display:none;"'; } ?>><?php _e( 'Add dynamic pricing', 'laterpay' ); ?>
    </a>
<?php endif; ?>
