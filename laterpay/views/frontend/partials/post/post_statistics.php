...
<div id="lp_js_post-statistics" class="lp_postStatistics<?php if ( $laterpay['hide_statistics_pane'] ) echo ' lp_is-hidden'; ?>">
    ...
    <a href="#" id="lp_js_toggle-post-statistics-visibility" class="lp_postStatistics_visibilityToggle" data-icon="l"></a>
    ...
    <div class="lp_postStatistics_details">
        <ul>
            <li>
                <span class="lp_sparklineBar" data-max="0.5"><?php echo LaterPay_Helper_View::get_days_statistics_as_string( $statistic['last30DaysBuyers'], 'percentage', ';' ); ?></span>
    ...
    <div class="lp_postStatistics_details">
        <ul>
            <li>
                <span class="lp_sparklineBar"><?php echo LaterPay_Helper_View::get_days_statistics_as_string( $statistic['last30DaysVisitors'], 'quantity', ';' ); ?></span>
            </li>
            <li>
    ...
    <div class="lp_postStatistics_pluginPreviewMode">
        ...
        <div class="lp_toggle">
            <form id="lp_postStatistics_pluginPreviewMode-form" method="post">
