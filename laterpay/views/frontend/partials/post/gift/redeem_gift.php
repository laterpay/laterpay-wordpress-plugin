...
<div>
    <?php if ( $pass ) : ?>
        <?php
            ...
            $period = LaterPay_Helper_Pass::get_period_options( $pass['period'] );
            if ( $pass['duration'] > 1 ) {
                $period = LaterPay_Helper_Pass::get_period_options( $pass['period'], true );
            }

            $price = LaterPay_Helper_View::format_number( $pass['price'] );

            $access_type = LaterPay_Helper_Pass::get_access_options( $pass['access_to'] );
