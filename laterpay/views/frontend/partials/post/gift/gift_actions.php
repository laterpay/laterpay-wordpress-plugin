...
<div class="lp_gift-card__actions">
    <?php if ( $laterpay['has_access'] ): ?>
        ...
        -->
    <?php else: ?>
        <a href="#" class="lp_js_doPurchase lp_purchase-link lp_button" title="<?php echo __( 'Buy now with LaterPay', 'laterpay' ); ?>" data-icon="b" data-laterpay="<?php echo $pass['url']; ?>" data-preview-as-visitor="<?php echo $laterpay['preview_post_as_visitor']?>"><?php echo $title; ?></a>
    <?php endif; ?>
</div>
