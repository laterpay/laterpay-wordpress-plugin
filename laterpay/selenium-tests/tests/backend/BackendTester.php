<?php //[STAMP] ada1e3025576d3f60d7448baeca759ba
...
use Codeception\Module\CommonHelper;
...
class BackendTester extends \Codeception\Actor
{
     ...
     * Usage examples:
      ...
      makeScreenshot(2);
     * @see \Codeception\Module\CommonHelper::mod()
     */
    public function mod($I, $module, $method) {
        return $this->scenario->runStep(new \Codeception\Step\Action('mod', func_get_args()));
    }
    ...
    public function trySeeInField($I, $string, $value) {
        return $this->scenario->runStep(new \Codeception\Step\Action('trySeeInField', func_get_args()));
    }
    ...
    public function trySee($I, $string) {
        return $this->scenario->runStep(new \Codeception\Step\Action('trySee', func_get_args()));
    }
    ...
    public function tryOption($I, $select, $option) {
        return $this->scenario->runStep(new \Codeception\Step\Action('tryOption', func_get_args()));
    }
    ...
    public function tryClick($I, $string) {
        return $this->scenario->runStep(new \Codeception\Step\Action('tryClick', func_get_args()));
    }
    ...
    public function tryCheckbox($I, $string) {
        return $this->scenario->runStep(new \Codeception\Step\Action('tryCheckbox', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\CommonHelper::setVar()
     */
    public function setVar($k, $v) {
        return $this->scenario->runStep(new \Codeception\Step\Action('setVar', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\CommonHelper::getVar()
     */
    public function getVar($k) {
        return $this->scenario->runStep(new \Codeception\Step\Action('getVar', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\CommonHelper::setDomain()
     */
    public function setDomain($url = null) {
        return $this->scenario->runStep(new \Codeception\Step\Action('setDomain', func_get_args()));
    }
