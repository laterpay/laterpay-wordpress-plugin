...
class CategoryPricesCest {
    ...
    public function testCheckCategoryPriceAutoAppliedIfNewCategoryPriceCreatedCest(BackendTester $I) {
        ...
        PostModule::of($I)
            ->createTestPost(BaseModule::$T1, BaseModule::$C1, BaseModule::$CAT1, 'global default price', 0.35, 60);
        ...
        PostModule::of($I)
            ->checkTestPostForLaterPayElements('test post 1', 'category default price', 0.28, 'USD',
    ...
    public function testCheckIfCategoryPriceAppliedToPostIfChangedCest(BackendTester $I) {
        ...
        PostModule::of($I)
            ->checkTestPostForLaterPayElements('test post 1', 'category default price', 0.10, 'USD',
                                               BaseModule::$T1, BaseModule::$C1, 60);
    ...
    public function testCheckIfCategoryPriceAppliedToPostWithGlobalDefaultPriceCest(BackendTester $I) {
        ...
        PostModule::of($I)
            ->createTestPost(BaseModule::$T1, BaseModule::$C1, BaseModule::$CAT1, 'global default price', 0.35, 60)
            ->assignPostToCategory(BaseModule::$T1, BaseModule::$CAT1)
            ->checkTestPostForLaterPayElements('test post 1', 'category default price', 0.28, 'USD',
                                               BaseModule::$T1, BaseModule::$C1, 60);
    ...
    public function testCheckPricesApplyingWithCategoryPriceDeletedCest(BackendTester $I) {
        ...
        PostModule::of($I)
            ->checkTestPostForLaterPayElements('test post 1', 'category default price', 0.89, 'USD',
                                               BaseModule::$T1, BaseModule::$C1, 60);
