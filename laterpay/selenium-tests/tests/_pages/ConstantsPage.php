...
class ConstantsPage {
    ...
    public static $C1 = 'LaterPay Test Category 1';
    public static $C2 = 'LaterPay Test Category 2';
    public static $C3 = 'LaterPay Test Category 3';
    public static $T1 = 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
...
nonumy eirmod tempor invidunt ut labore.';
    public static $T2 = '[laterpay_premium_download target_page_title="LaterPay WordPress Plugin Shortcode Test" target_page_id={ID of the respective post}
