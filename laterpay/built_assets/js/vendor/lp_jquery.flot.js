            ...
            options = {
                ...
                series: {
                    ...
                    lines: {
                        ...
                        fillColor: null,
                        gaps: false,
                        // create gap around points to better distinguish them
                        // visually;
                        // don´t forget to also provide values and settings
                        // for points!
                        steps: false
                ...
                for (var i = ps; i < points.length; i += ps) {
                    ...
                    if (series.lines.gaps) {
                        ...
                        var gap         = 2.5 * lw, // gap is 2.5 times the line width
                            ...
                            y2_adjusted = axisy.p2c(y2) - gap * Math.sin(alpha2);

                        if (x1_adjusted != prevx || y1_adjusted != prevy)
                            ctx.moveTo(x1_adjusted + xoffset, y1_adjusted + yoffset);
