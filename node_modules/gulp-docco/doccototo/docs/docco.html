      ...
      <ul id="jump_to">
        <li>
          ...
          <div id="jump_page">
              ...
              <a class="source" href="doccoaswell.html">
                doccoaswell.litcoffee
              </a>
...
name of the source file.</p>
            ...
            <div class="content"><div class='highlight'><pre>  first = marked.lexer(sections[<span class="hljs-number">0</span>].docsText)[<span class="hljs-number">0</span>]
...
user-specified options.</p>
  ...
  <span class="hljs-attribute">languages</span>:  {}</pre></div></div>
...
highlightjs = <span class="hljs-built_in">require</span> <span class="hljs-string">'highlight.js'</span></pre></div></div>
        ...
        <li id="section-16">
            ...
            <div class="content"><div class='highlight'><pre>marked.setOptions <span class="hljs-attribute">smartypants</span>: <span class="hljs-literal">yes</span></pre></div></div>
  ...
  <span class="hljs-keyword">else</span>
    <span class="hljs-built_in">console</span>.log commander.helpInformation()</pre></div></div>
        ...
        <li id="section-26">
            ...
            <div class="content"><div class='highlight'><pre>Docco = <span class="hljs-built_in">module</span>.<span class="hljs-built_in">exports</span> = {run, <span class="hljs-built_in">document</span>, parse, format, version}</pre></div></div>
