<?php //[STAMP] 81868fd682aae496defb65769db5c339
...
class BackendTester extends \Codeception\Actor
{
     ...
     * @return bool
     * @see \Codeception\Module\CommonHelper::trySeeElement()
     */
    public function trySeeElement($I, $selector, $attr = null) {
        return $this->scenario->runStep(new \Codeception\Step\Action('trySeeElement', func_get_args()));
    }
